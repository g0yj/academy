...
insert into  employee(era,ename) value ('강사1','황태웅');
insert into  employee(era,ename) value ('행정1','이진형');
insert into  employee(era,ename) value ('강사2','김근배');
...
insert  into student (sname,saddress,sphone,eno) values('박상빈','시흥','010-1111-1111',2);
insert  into student (sname,saddress,sphone,eno) values('고연진','인천','010-2222-2222',2);
insert  into student (sname,saddress,sphone,eno) values('이진형','부산','010-3333-3333',3);
insert  into student (sname,saddress,sphone,eno) values('황기준','대구','010-4444-4444',3);
insert  into student (sname,saddress,sphone,eno) values('김찬희','대구','010-5555-5555',2);
...
select eno, sno, sname, saddress, sphone from student natural join employee where eno =2  ;

#강사번호 학생번호 학생이름 학생주소 학생전화번호